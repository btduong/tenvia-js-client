...
async function fetchWithHandling<T>(
  url: string,
  options?: RequestInit
): Promise<ServiceResponseResult<T>> {
  try {
...
export const serviceApi = {
  ...
  ): Promise<ServiceResponseResult<GameSession>> {
  ...
  async usePowerUp(
    ...
    userId: number,
    sessionId: string
  ): Promise<ServiceResponseResult<UsePowerUpResponse>> {
  ...
  ): Promise<ServiceResponseResult<AnswerResponse>> {
  ...
  ): Promise<ServiceResponseResult<User>> {
