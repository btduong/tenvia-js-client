...
import type { Inventory, PowerUpType, UsePowerUpResponse, AnswerResponse, Question } from '@/types';
 ...
 */
export const GameProvider: React.FC<{ value: GameContextType; children: React.ReactNode }> = ({
  value,
  children,
}) => {
